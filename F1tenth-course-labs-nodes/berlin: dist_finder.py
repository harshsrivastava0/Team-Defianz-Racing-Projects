...
forward_projection = 2.0	# distance (in m) that we project the car forward for correcting the error. You have to adjust this.
desired_distance = 1.8	# distance from the wall (in m). (defaults to right wall)
